...
module.exports = function (name, pwd, hostname) {
	...
	return {
		...
		// Add by Rémy Martin
		vm: {
			current: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/current';
				get(url, data, callback);
			},

			reboot: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/reboot';
				post(url, data, callback);
			},

			reset: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/reset';
				post(url, data, callback);
			},

			resume: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/resume';
				post(url, data, callback);
			},
			shutdown: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/shutdown';
				post(url, data, callback);
			},
			start: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/start';
				post(url, data, callback);
			},
			stop: function (node, vmid, callback) {
				data = {};
				url = '/nodes/' + node + '/qemu/' + vmid + '/status/stop';
				post(url, data, callback);
			},
			suspend: function (node, vmid, callback) {
				data = {};
